...
def generate_table_and_plot(alpha, beta, num_weeks, control_cr, total_sample_size, num_variants):
    ...
    ax1.set_title("Minimum Detectable Effect vs. Total Sample Size", fontsize=8, fontweight='bold', pad=10)
    ...
    ax2 = ax1.twinx()
    ax2.bar(range(1, num_weeks+1), total_sample_size_values/1000, alpha=1.0, color='#000000')
    ax2.set_ylabel('Total Sample Size', color='#000000')
    ax2.tick_params('y', colors='#000000')
    ax2.set_ylabel('Total Sample Size', fontsize=6, fontweight='bold', color='#000000', labelpad=10)
