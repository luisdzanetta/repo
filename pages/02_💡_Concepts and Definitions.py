...
st.markdown("O nível de probabilidade em que se concorda em rejeitar a hipótese nula. Por convenção, 0.05")
...
st.markdown("O erro que resulta quando a hipótese nula é falsamente aceita.")
